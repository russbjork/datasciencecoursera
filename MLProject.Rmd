...
Classification Tree generates an accuracy of 60.1% using cross-validation with 5 steps.  

Random Forest generates an accuracy of 99.3% using cross-validation with 5 steps.  

Gradient Boost generates an accuracy of 96.1% using cross-validation with 5 steps.  
